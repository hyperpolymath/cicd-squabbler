...
[arabic]
. Navigate to
https://github.com/hyperpolymath/cicd-squabbler/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/cicd-squabbler/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/cicd-squabbler/discussions[GitHub
Discussions]
...
_Thank you for helping keep Cicd Squabbler and its users safe._ 🛡️
