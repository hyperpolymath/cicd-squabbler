...
# Threat Model: cicd-squabbler — an intelligent, detachable CI/CD fighter
...
Brief description of cicd-squabbler — an intelligent, detachable CI/CD fighter and its architecture.
