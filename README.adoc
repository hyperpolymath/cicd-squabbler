...
NOTE: Status — *v0.1 scaffold, DRAFT (2026-06-29).* The engine and its formal
invariant are real and verified (see below); the GitHub App webhook server is an
honest stub. No GitHub repo exists yet (creation is owner-gated). See
`docs/CHARTER.adoc` for the full design and the open owner decisions.
